...
// client/shared/basePath.ts
var LOGO_PATH = "/static/logo.png";
var readBasePathFromBaseTag = () => {
...
var resolvePortalAssetUrl = (url) => {
  if (!url) return "";
  if (url.startsWith("http://") || url.startsWith("https://")) return url;
  return portalUrl(url.startsWith("/") ? url : `/${url}`);
};
var stripBasePath = (pathname) => {
  const base = getBasePath();
...
var getPublicOrigin = () => `${window.location.origin}${getBasePath()}`;
var logoUrl = () => portalUrl(LOGO_PATH);

// client/shared/api.ts
...
var CircleArrowUp = createLucideIcon("circle-arrow-up", __iconNode7);
...
var Settings2 = createLucideIcon("settings-2", __iconNode20);
...
var Tv = createLucideIcon("tv", __iconNode22);
...
var Activity = createLucideIcon("activity", __iconNode24);
...
var ArrowLeft = createLucideIcon("arrow-left", __iconNode25);
...
var Calendar = createLucideIcon("calendar", __iconNode26);
...
var ChartColumn = createLucideIcon("chart-column", __iconNode27);
...
var ChartLine = createLucideIcon("chart-line", __iconNode28);
...
var ChartPie = createLucideIcon("chart-pie", __iconNode29);

// node_modules/lucide-react/dist/esm/icons/chevron-left.mjs
var __iconNode30 = [["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }]];
var ChevronLeft = createLucideIcon("chevron-left", __iconNode30);

// node_modules/lucide-react/dist/esm/icons/chevron-right.mjs
var __iconNode31 = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]];
var ChevronRight = createLucideIcon("chevron-right", __iconNode31);
...
var CircleAlert = createLucideIcon("circle-alert", __iconNode32);
...
var CircleCheckBig = createLucideIcon("circle-check-big", __iconNode33);
...
var CircleCheck = createLucideIcon("circle-check", __iconNode34);
...
var CirclePlay = createLucideIcon("circle-play", __iconNode35);
...
var CirclePlus = createLucideIcon("circle-plus", __iconNode36);
...
var CircleX = createLucideIcon("circle-x", __iconNode37);
...
var Clapperboard = createLucideIcon("clapperboard", __iconNode38);
...
var ClipboardList = createLucideIcon("clipboard-list", __iconNode39);
...
var ClipboardPaste = createLucideIcon("clipboard-paste", __iconNode40);
...
var CloudDownload = createLucideIcon("cloud-download", __iconNode41);
...
var CodeXml = createLucideIcon("code-xml", __iconNode42);
...
var Coffee = createLucideIcon("coffee", __iconNode43);
...
var Compass = createLucideIcon("compass", __iconNode44);
...
var Copy = createLucideIcon("copy", __iconNode45);
...
var Download = createLucideIcon("download", __iconNode46);
...
var Ellipsis = createLucideIcon("ellipsis", __iconNode47);
...
var EyeOff = createLucideIcon("eye-off", __iconNode48);
...
var Eye = createLucideIcon("eye", __iconNode49);
...
var FileText = createLucideIcon("file-text", __iconNode50);
...
var Globe = createLucideIcon("globe", __iconNode51);
...
var GripVertical = createLucideIcon("grip-vertical", __iconNode52);
...
var HardDrive = createLucideIcon("hard-drive", __iconNode53);
...
var House = createLucideIcon("house", __iconNode54);
...
var Lightbulb = createLucideIcon("lightbulb", __iconNode55);
...
var LogOut = createLucideIcon("log-out", __iconNode56);
...
var Mail = createLucideIcon("mail", __iconNode57);
...
var MonitorSmartphone = createLucideIcon("monitor-smartphone", __iconNode58);
...
var Monitor = createLucideIcon("monitor", __iconNode59);
...
var Music = createLucideIcon("music", __iconNode60);
...
var Palette = createLucideIcon("palette", __iconNode61);
...
var PartyPopper = createLucideIcon("party-popper", __iconNode62);
...
var PenLine = createLucideIcon("pen-line", __iconNode63);
...
var Plus = createLucideIcon("plus", __iconNode65);
...
var Save = createLucideIcon("save", __iconNode66);
...
var Server = createLucideIcon("server", __iconNode67);
...
var Share2 = createLucideIcon("share-2", __iconNode68);
...
var Shield = createLucideIcon("shield", __iconNode69);
...
var Sparkles = createLucideIcon("sparkles", __iconNode70);
...
var SquarePlay = createLucideIcon("square-play", __iconNode71);
...
var TriangleAlert = createLucideIcon("triangle-alert", __iconNode73);
...
var TrendingUp = createLucideIcon("trending-up", __iconNode74);
...
var Trophy = createLucideIcon("trophy", __iconNode75);
...
var Users = createLucideIcon("users", __iconNode76);

// client/shared/ui.tsx
var import_react4 = __toESM(require_react(), 1);
var import_react_dom = __toESM(require_react_dom(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var getFixedDropdownPosition = (rect, { width = 160, itemCount = 6, align = "right" } = {}) => {
...
var CustomSelect = ({ id, value, onChange, options, className, compact = false }) => {
  const [isOpen, setIsOpen] = (0, import_react4.useState)(false);
  const [dropPos, setDropPos] = (0, import_react4.useState)(null);
  ...
  (0, import_react4.useEffect)(() => {
    const handleClickOutside = (event) => {
      ...
      if (t && !t.contains(event.target) && d && !d.contains(event.target)) {
        setIsOpen(false);
      }
    };
  ...
  const dropdown = isOpen && dropPos ? import_react_dom.default.createPortal(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `relative ${className || ""}`, ref: triggerRef, id, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `truncate mr-4 font-medium ${compact ? "text-xs" : "text-sm"}`, children: selectedOption?.label || "Select..." }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `text-[10px] transition-transform ${isOpen ? "rotate-180" : ""}`, children: "\u25BC" })
        ]
      }
    ),
    dropdown
...
var StyledCheckbox = ({ checked, onChange, label }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "flex items-center gap-2 text-xs text-muted", children: [
  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "relative inline-flex h-4 w-4 items-center justify-center", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "input",
      {
        type: "checkbox",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-4 w-4 rounded border border-border bg-background transition-colors peer-checked:border-plex peer-checked:bg-plex/20" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "pointer-events-none absolute h-3 w-3 text-plex opacity-0 transition-opacity peer-checked:opacity-100" })
  ] }),
  label
] });
var OverlayCheckbox = ({ checked, onChange, size = "md", title, className = "" }) => {
  const box = size === "sm" ? "h-3.5 w-3.5" : "h-5 w-5";
  const icon = size === "sm" ? "h-2.5 w-2.5" : "h-3.5 w-3.5";
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: `relative inline-flex cursor-pointer ${className}`, title, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "input",
      {
        type: "checkbox",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `${box} rounded-md border-2 border-white/35 bg-black/80 shadow-[0_2px_8px_rgba(0,0,0,0.45)] backdrop-blur-sm transition-all peer-checked:border-plex peer-checked:bg-plex/25 peer-hover:border-white/60` }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: `pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 ${icon} text-plex opacity-0 transition-opacity peer-checked:opacity-100` })
  ] });
};
var SettingsSwitch = ({ checked, onChange, className = "", id }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: `relative inline-flex items-center cursor-pointer ml-4 flex-shrink-0 ${className}`, children: [
  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "input",
    {
      id,
  ...
  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-11 h-6 bg-background peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-text after:border-border after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-plex" })
] });
var SettingsToggleRow = ({ title, description, hint, checked, onChange, className = "", border = true, children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `${border ? "py-4 border-b border-border/40" : "py-4"} ${className}`, children: [
  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "min-w-0", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", { className: "font-bold text-text inline-flex items-center gap-1.5 flex-wrap", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: title }),
        !description && hint
      ] }),
      description ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-sm text-muted mt-1 inline-flex items-center gap-1.5 flex-wrap", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: description }),
        hint
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SettingsSwitch, { checked, onChange })
  ] }),
  children
] });
var ConfirmModal = ({ isOpen, message, onConfirm, onCancel }) => {
  if (!isOpen) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-fade-in", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-glass animate-slide-up", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-xl font-black mb-4 text-text tracking-tight", children: "Are you sure?" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-muted mb-8 text-sm leading-relaxed", children: message }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex gap-3 justify-end", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "btn-secondary px-4 py-2.5 text-sm", onClick: onCancel, children: "Cancel" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "btn-primary px-4 py-2.5 text-sm", onClick: onConfirm, children: "Confirm" })
    ] })
  ] }) });
};
var ScrollReveal = ({ children, enabled = true, delay = 0, className = "" }) => {
  const [isVisible, setIsVisible] = (0, import_react4.useState)(!enabled);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref, className: `${className} transition-all duration-700 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`, style: { transitionDelay: `${delay}ms` }, children });
};

// client/shared/toast.tsx
var import_react5 = __toESM(require_react(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var MAX_VISIBLE_TOASTS = 3;
var pushToast = (prev, message, type) => {
...
var Toast = ({ message, type, onDismiss }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "div",
    {
      className: `px-3 py-2 rounded-lg text-white text-sm font-medium shadow-lg transition-all duration-300 transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-2 opacity-0"} ${type === "success" ? "bg-green-600" : "bg-red-600"}`,
      children: message
    }
  );
};
var ToastContainer = ({ toasts, setToasts }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "fixed z-[2000] flex flex-col-reverse gap-1.5 w-[min(18rem,calc(100vw-2rem))] bottom-5 left-1/2 -translate-x-1/2 md:bottom-auto md:left-auto md:translate-x-0 md:top-4 md:right-4", children: toasts.map((toast) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Toast, { ...toast, onDismiss: () => setToasts((t) => t.filter((item) => item.id !== toast.id)) }, toast.id)) });
var Loader = ({ isLoading, isCinematic }) => {
  if (!isLoading) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: `fixed inset-0 ${isCinematic ? "bg-black/90" : "bg-black/50 backdrop-blur-sm"} flex justify-center items-center z-[3000]`, children: isCinematic ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-col items-center", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: "100", height: "100", viewBox: "0 0 100 100", className: "animate-pulse", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "mt-8 tracking-[0.4em] uppercase text-xs text-plex font-bold animate-pulse drop-shadow-[0_0_8px_rgba(229,160,13,0.8)]", children: "Loading" })
  ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "border-4 border-border border-t-plex rounded-full w-12 h-12 animate-spin shadow-[0_0_15px_rgba(229,160,13,0.5)]" }) });
};
...
lucide-react/dist/esm/icons/arrow-up-from-line.mjs:
