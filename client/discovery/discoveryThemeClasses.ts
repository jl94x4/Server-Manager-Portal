...
export const discoveryTheme = {
    ...
    searchInput: 'w-full bg-background/60 border-2 border-border focus:border-plex rounded-xl py-3.5 sm:py-4 pl-12 sm:pl-14 pr-12 text-base sm:text-lg text-text font-medium outline-none transition-all placeholder:text-muted/50 shadow-inner backdrop-blur-sm',
    searchDropdown: 'max-h-[min(420px,50vh)] overflow-y-auto custom-scrollbar rounded-xl border border-border bg-card/98 backdrop-blur-xl shadow-2xl',
    searchResultBtn: 'w-full flex items-center gap-4 p-3 hover:bg-white/5 border-b border-border/60 last:border-0 text-left transition-colors',
