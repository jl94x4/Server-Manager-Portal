...
export const discoveryTheme = {
    ...
    tabActive: 'bg-plex text-black shadow-[0_0_18px_rgba(229,160,13,0.28)] hover:bg-plex hover:text-black',
    ...
    searchInput: 'w-full bg-background/75 border-2 border-border/80 focus:border-plex focus:bg-background rounded-2xl py-4 sm:py-[1.15rem] pl-12 sm:pl-14 pr-12 text-base sm:text-lg text-text font-medium outline-none transition-all placeholder:text-muted/55 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_12px_40px_rgba(0,0,0,0.25)]',
