...
export const discoveryTheme = {
    ...
    searchInput: 'w-full bg-background/75 border-2 border-border/80 focus:border-plex focus:bg-background rounded-xl py-2.5 sm:py-3 pl-11 sm:pl-12 pr-11 text-sm sm:text-base text-text font-medium outline-none transition-all placeholder:text-muted/55 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_8px_24px_rgba(0,0,0,0.2)]',
