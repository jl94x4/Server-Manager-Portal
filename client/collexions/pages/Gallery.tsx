            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        className="w-full bg-slate-900/50 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-white focus:outline-none focus:border-plex transition-colors"
                    />
                </div>
                ...
                <div className="relative w-full md:w-64">
                    <button
                        ...
                        className="w-full bg-slate-900/50 border border-slate-800 rounded-xl py-2.5 pl-4 pr-10 text-white flex items-center justify-between focus:outline-none focus:border-plex transition-all hover:bg-slate-800/50"
                    >
                                ...
                                <div className="max-h-60 overflow-y-auto scrollbar-thin">
                                    {libraries.map(lib => (
                                        <button
                                            ...
                                            className={`w-full px-4 py-2.5 text-sm text-left flex items-center justify-between transition-colors hover:bg-slate-800 ${selectedLibrary === lib ? 'text-plex bg-plex/5' : 'text-slate-300'
                                                }`}
                                        >
                                            {lib}
                    ...
                    return (
                        <div key={uniqueKey} className={`group relative flex flex-col bg-slate-900/40 border border-slate-800 rounded-2xl overflow-hidden hover:border-slate-600 transition-all hover:shadow-2xl hover:shadow-black/50 ${gridSize === 'sm' ? 'rounded-xl' : 'rounded-2xl'}`}>
                            ...
                            <div className="aspect-[2/3] bg-slate-800 relative overflow-hidden">
                                ...
                                {coll.is_pinned && (
                                    <div className={`absolute top-2 right-2 bg-plex text-white font-bold rounded flex items-center gap-1 shadow-lg ring-1 ring-white/20 ${gridSize === 'sm' ? 'px-1 py-0.5 text-[8px]' : 'px-2 py-1 text-[10px]'}`}>
                            ...
                            <div className={`${gridSize === 'sm' ? 'p-2' : 'p-4'} flex-1 flex flex-col justify-between`}>
                                <div className={gridSize === 'sm' ? 'mb-1' : 'mb-3'}>
                                    <h3 className={`font-bold text-white line-clamp-2 leading-snug group-hover:text-plex transition-colors ${gridSize === 'sm' ? 'text-[10px]' : 'text-sm'}`}>
                                        {coll.title}
                                    </h3>
                                    {gridSize !== 'sm' && (
