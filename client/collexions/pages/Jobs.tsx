        ...
        <div className="space-y-8 animate-in fade-in duration-500 pb-10">
            ...
            <div className="bg-slate-900/40 border border-slate-800 p-4 rounded-2xl flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative w-full md:w-96 group">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-plex transition-colors" />
                    <input
                        type="text"
                        placeholder="Search jobs or libraries..."
                        value={searchQuery}
                        onChange={(e) => { setSearchQuery(e.target.value); setCurrentPage(1); }}
                        className="w-full bg-slate-950/50 border border-slate-800 rounded-xl pl-10 pr-4 py-2.5 text-slate-200 focus:outline-none focus:ring-2 focus:ring-plex/30 focus:border-plex/50 transition-all"
                    />
                </div>
            ...
            {Object.keys(jobs).length === 0 ? (
                <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-12 text-center flex flex-col items-center">
                    ...
                    <a
                        href="/creator"
                        className="inline-flex items-center gap-2 bg-plex hover:bg-plex/80 text-white px-6 py-3 rounded-xl font-bold transition-all transform hover:scale-105"
                    >
                            ...
                            <div key={id} className="bg-slate-900/40 border border-slate-800 rounded-xl p-5 hover:border-slate-700 transition-all group">
                                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                    ...
                                    <div className="flex items-start gap-4">
                                        <div className="p-3 bg-slate-800 rounded-lg text-plex">
