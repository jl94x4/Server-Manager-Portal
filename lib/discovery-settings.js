...
/** Phase 10: Discover is TMDB-only (Seerr metadata rollback removed). */
export const normalizeDiscoverySource = (_value) => 'tmdb';

/** Effective Discover metadata source — always TMDB after Phase 10 hard cut. */
export const getDiscoverySource = (_config = {}) => 'tmdb';

/** Phase 10: portal is the only request engine (Seerr live engine removed). */
export const normalizeRequestEngine = (_value) => 'portal';

/** Member request persistence engine — always portal JSON + *arr. */
export const getRequestEngine = (_config = {}) => 'portal';

/** True when portal requests should unlock Discover / Requests nav. */
export const isPortalRequestNavReady = (_config = {}) => true;
