/**
 * Portal-native request helpers (Phases 5–6).
...
const filterAdminRequestTab = (dto, filter) => {
    ...
    if (filter === 'approved' || filter === 'processing') return status === REQUEST_STATUS_APPROVED;
    // Available sync is Phase 7 — treat as empty for now.
