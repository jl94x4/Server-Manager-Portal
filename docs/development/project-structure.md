...
`lib/portal-request/` holds the portal-native Discover/request engine (Seerr uncouple). Phase 2–3: TMDB dual-run + *arr library availability. See [seerr-uncouple-inventory.md](./seerr-uncouple-inventory.md).
