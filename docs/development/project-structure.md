...
`lib/portal-request/` holds the portal-native Discover/request engine (Seerr uncouple). Phase 5: optional `requestEngine=portal` JSON request store. See [seerr-uncouple-inventory.md](./seerr-uncouple-inventory.md).
