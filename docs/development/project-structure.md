...
`lib/portal-request/` holds the portal-native Discover/request engine (Seerr uncouple). Phase 5–8: JSON requests/issues, *arr approve + status sync, portal quotas/auto-approve. See [seerr-uncouple-inventory.md](./seerr-uncouple-inventory.md).
